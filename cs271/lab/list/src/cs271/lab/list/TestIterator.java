...
public class TestIterator {
    ...
    public void setUp() throws Exception {
        ...
        // TODO also try with a LinkedList done - does it make any difference?(not sure List is faster than a LinkedList in
    ...
    public void testRemove() {
        ...
        while (i.hasNext()) {
            if (i.next() == 77) {
              //list.remove(77);
                 i.remove();
                 // (done) TODO what happens if you use list.remove(77)? Failed test called (IndexOutOfBoundsException)
                // because the size of the list is 7. There is no index 77
            }
        }
