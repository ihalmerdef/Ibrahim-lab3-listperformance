   ...
   private LinkedList<Integer>list;
    ...
    public void setUp() throws Exception {
       // list = new ArrayList<Integer>();
        ...
        // TODO also try with a LinkedList done - does it make any difference? (LinkedList is faster than a List)
    }
    ...
    public void testContains() {
        // TODO write assertions using done
        list.add(77);
        list.contains(77);
        assertEquals(77,list.get(0).intValue());
        // list.contains(77)
    ...
    public void testRemoveObject() {
        ...
        list.add(77);
        list.add(6);
        list.remove(5); // what does this method do? removes the value under index 5 which is 77(done)
        // TODO fix the expected values in the assertions below done
        ...
        // Removes the first occurrence of object 5 from this list(done)
    ...
    public void testContainsAll() {
        ...
        list.add(77);
        list.add(66);
        // TODO using containsAll and Arrays.asList (see above), done
        list.containsAll(Arrays.asList(33,77,44,77,55,77,66));
        // 1) assert that list contains all five different numbers added
        assertEquals(Arrays.asList(33,77,44,77,55,77,66), list);
        //or assertTrue( list.containsAll(Arrays.asList(33,77,44,77,55,77,66)));
    ...
    public void testAddAll() {
        // TODO in a single statement using addAll and Arrays.asList, done
    ...
    public void testRemoveAll() {
        ...
        list.add(77);
        list.add(66);
        // TODO in a single statement using removeAll and Arrays.asList, done
    ...
    public void testRetainAll() {
        ...
        list.add(77);
        list.add(66);
        // TODO in a single statement using retainAll and Arrays.asList, done
        // remove items from the list to make the following assertions pass
